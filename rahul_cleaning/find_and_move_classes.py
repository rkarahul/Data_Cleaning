...
# dataset_dir = r"teeth_all_data"
# destination_dir = r"teeth_all_data_ok"
...
#         if len(set(classes)) == 1 and '4' in classes:
#             #os.remove(os.path.join(dataset_dir, file_name))
...
# dataset_dir = r"mix_data_unclean"
# destination_dir = r"mix_data_unclean_ok"
