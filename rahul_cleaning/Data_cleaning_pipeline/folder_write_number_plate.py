...
output_folder = r"Data_output_number"  # Output folder to save YOLO format txt files

# Load the pre-trained YOLOv8 model
model = get_model(model_id="license-plate-recognition-rxg4e/4", api_key="xZlFzpd81h8HQGYlMpjh")
